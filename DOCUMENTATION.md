...
published schedule for the department ending before this one starts. Fairness
does **not** yet cross this boundary — weekend and night loads are counted per
solve, so equity is guaranteed within a month and not across months. This exact set is the canonical
