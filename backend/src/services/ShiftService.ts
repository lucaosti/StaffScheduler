 ...
 * service for skill rows. It reads `shift_templates` directly rather than
 * through `ShiftTemplateService` (template CRUD, a separate class): expanding
 * a template into shifts is a shift-lifecycle operation, not a template one.
 *
